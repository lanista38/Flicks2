...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        upComingViewController.tabBarItem.image = UIImage(named: "up_coming")
        ...
        UINavigationBar.appearance().barTintColor = UIColor(red: 255.0/255.0, green: 112.0/255.0, blue: 67.0/255.0, alpha: 1.0)
        UITabBar.appearance().tintColor = UIColor(red: 255.0/255.0, green: 112.0/255.0, blue: 67.0/255.0, alpha: 1.0)
